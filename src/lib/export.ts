 ...
 * Each day gets its own sheet, named by day number + month.
 */
export async function downloadMonthXLSX(
	monthDayGroups: Record<string, Session[]>,
	resolveRoutineName: (session: Session) => string,
	year: number,
	month: number,
	monthLabel: string
