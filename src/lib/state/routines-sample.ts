/**
 * routines-sample.ts — JustinGuitar Beginner Course (Modules 1–12).
...
import type { Exercise, Routine } from './types.js';
...
function omc(title: string): Exercise {
...
export const module1Routine: Routine = {
	id: 'module-1',
	name: 'Module 1',
...
export const module2Routine: Routine = {
	id: 'module-2',
	name: 'Module 2',
...
const module3Exercises: Exercise[] = [
...
export const module3Routine: Routine = {
	id: 'module-3',
	name: 'Module 3',
...
const module4Exercises: Exercise[] = [
...
export const module4Routine: Routine = {
	id: 'module-4',
	name: 'Module 4',
...
const module5Exercises: Exercise[] = [
	createExercise({ title: 'Beginner Finger Stretch', durationSec: min(2) }),
...
export const module5Routine: Routine = {
	id: 'module-5',
	name: 'Module 5',
...
const module6Exercises: Exercise[] = [
...
export const module6Routine: Routine = {
	id: 'module-6',
	name: 'Module 6',
...
const module7Exercises: Exercise[] = [
...
export const module7Routine: Routine = {
	id: 'module-7',
	name: 'Module 7',
...
const module8Exercises: Exercise[] = [
...
export const module8Routine: Routine = {
	id: 'module-8',
	name: 'Module 8',
...
const module9Exercises: Exercise[] = [
	createExercise({ title: 'Repertoire Revision', durationSec: min(5) }),
...
export const module9Routine: Routine = {
	id: 'module-9',
	name: 'Module 9',
...
const module10Exercises: Exercise[] = [
	createExercise({ title: 'Repertoire Revision', durationSec: min(5) }),
...
export const module10Routine: Routine = {
	id: 'module-10',
	name: 'Module 10',
...
const module11Exercises: Exercise[] = [
	createExercise({ title: 'Repertoire Revision', durationSec: min(5) }),
	createExercise({ title: 'F And Changes (L11)', durationSec: min(2) }),
...
export const module11Routine: Routine = {
	id: 'module-11',
	name: 'Module 11',
...
const module12Exercises: Exercise[] = [
	createExercise({ title: 'Repertoire Revision', durationSec: min(5) }),
	createExercise({ title: 'F And Changes (L11)', durationSec: min(2) }),
...
export const module12Routine: Routine = {
	id: 'module-12',
	name: 'Module 12',
